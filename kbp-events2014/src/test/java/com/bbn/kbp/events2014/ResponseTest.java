...
public class ResponseTest {
    ...
    public void testDistinguishPJAndAAJHashes() {
        ...
        final Response r1 = Response.createFrom(doc, type,
                role, CAS, baseFiller,
                ImmutableSet.<CharOffsetSpan>of(), ImmutableSet.of(CharOffsetSpan.fromOffsetsOnly(1039, 1243), CharOffsetSpan.fromOffsetsOnly(642, 838)),
                realis);

        final Response r2 = Response.createFrom(doc, type,
                role, CAS, baseFiller,
                ImmutableSet.<CharOffsetSpan>of(CharOffsetSpan.fromOffsetsOnly(1039, 1243)), ImmutableSet.of(CharOffsetSpan.fromOffsetsOnly(642, 838)),
                realis);
