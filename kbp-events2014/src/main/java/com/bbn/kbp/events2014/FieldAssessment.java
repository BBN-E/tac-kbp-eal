...
public enum FieldAssessment {
	...
	/**
	 * Parse a single character to a {@code KBPFieldAnnotation}. "C" is correct,
	 * "W" is incorrect, and "I" is inexact.
	 *
	 * @param s
	 * @return
	 */
	...
	/**
	 * Same as {@code parse}, except it translates the special
	 * values {@code NIL} to {@code Optional.absent()}.
	 * @param s
	 * @return
	 */
    ...
    /**
     * Same as {@code asCharacter}, except it returns {@code NIL} if provided with {@code Optional.absent()}.
     * @param ann
     * @return
     */
	...
	/**
	 * Returns true if the assessment is not wholly wrong (i.e. not <tt>INCORRECT</tt>
	 * or <tt>IGNORE</tt>).
	 *
	 * @return
	 */
    ...
    /**
     * Like {@code isAcceptable}, but also accepts {@code Optional.absent()} input
