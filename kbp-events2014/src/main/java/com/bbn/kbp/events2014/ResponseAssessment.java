...
public final class ResponseAssessment {
  ...
  public static ResponseAssessment create(
      final Optional<FieldAssessment> justificationSupportsEventType,
    ...
    return new ResponseAssessment(justificationSupportsEventType.orNull(),
        justificationSupportsFiller.orNull(),
