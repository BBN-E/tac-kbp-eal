...
public enum KBPRealis {
  ...
  /**
   * Parses a string from {@code asString} as a realis. {@code NIL} becomes {@code
   * Optional.absent()}. Invalid values will raise an exception.
   */
  ...
  /**
   * Returns a string representation of a realis suitable for inclusion in a KBP EA task output
   * file. {@code Optional.absent()} becomes {@code NIL}.
   */
