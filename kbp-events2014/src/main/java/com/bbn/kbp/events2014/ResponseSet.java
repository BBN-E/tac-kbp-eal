...
/**
 * Represents a set of responses.  The default comparison method is to
 * do a lexicographical sort of the unique IDs of the (sorted) responses.
 */
public final class ResponseSet implements Comparable<ResponseSet> {
