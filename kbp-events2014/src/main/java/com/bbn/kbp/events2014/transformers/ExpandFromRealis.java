...
/**
 * From an answer key, we can derive additional assessed responses automatically by copying the
 * assessed tuple, but replacing the realis in the original tuple with the assessor's realis.  This
 * class carries out this answer key expansion.
 */
public final class ExpandFromRealis implements Function<AnswerKey, AnswerKey> {
  ...
  private ExpandFromRealis create() {
