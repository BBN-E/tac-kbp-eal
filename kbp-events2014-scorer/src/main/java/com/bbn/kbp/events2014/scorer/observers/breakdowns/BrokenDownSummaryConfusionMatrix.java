...
public final class BrokenDownSummaryConfusionMatrix<SignatureType> {
     ...
     * where the keys of the result will be ordered by {@code ordering}.  We require the ordering to maintain
    ...
    public static final class Builder<SignatureType> {
        ...
        public Builder<SignatureType> combine(BrokenDownSummaryConfusionMatrix<SignatureType> dataToAdd) {
            for (final Map.Entry<SignatureType, SummaryConfusionMatrix> entry : dataToAdd.asMap().entrySet()) {
