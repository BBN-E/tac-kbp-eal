...
public class KBPScoreTabulator {
    ...
    public static Map<String, String> getConfigurationDescriptions(File masterAnnotationRepo) throws IOException {
        final Map<String, String> configDescriptions = new HashMap<String, String>();
    ...
    public static void trueMain(String[] args) throws IOException {
        ...
        Map<String, String> systemDescriptions = getConfigurationDescriptions(masterAnnotationRepo);
        ...
        for (String dataset : datasets) {
            ...
            if (!datasetScoreDir.exists()) {
                log.info("No directory for dataset {} under {}", dataset, scoreTrackerDirectory);
                continue;
            }
    ...
    private static String buildDescriptionTable(
            Map<String, String> systemDescriptions)
    {
        final StringBuilder sb = new StringBuilder();
        sb.append("<table border=\"1\">");
