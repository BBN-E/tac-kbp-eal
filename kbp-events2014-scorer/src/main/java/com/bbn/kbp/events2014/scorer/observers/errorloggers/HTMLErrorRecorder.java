 ...
 * implementation has many dependencies on internal Serif code which can't be distributed, so for
 * public release we just provide an interface with a null implementation. Someone else could write
 * another implementation if they wanted to. This is a bit of a hack.
 */
