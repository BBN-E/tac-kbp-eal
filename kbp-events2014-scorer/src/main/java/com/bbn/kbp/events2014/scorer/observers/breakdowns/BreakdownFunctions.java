...
public final class BreakdownFunctions {
  ...
  public static final Function<TypeRoleFillerRealis, Symbol> TypeDotRole =
  ...
  /**
   * Will identify genres for ACE and pilot documents. Ideally this would be refactored to read the
   * mappings from a file.
   */
  ...
  private static class GenreFunction implements Function<TypeRoleFillerRealis, Symbol> {
    ...
    private static final ImmutableMap<String, Symbol> prefixToGenre =
        ImmutableMap.copyOf(MultimapUtils.copyAsMap(
            ImmutableMultimap.<Symbol, String>builder()
                ...
                .putAll(BLOG, "AGGRESSIVEVOICEDAILY", "BACONSREBELLION",
                    "FLOPPING_ACES", "GETTINGPOLITICAL", "HEALINGIRAQ", "MARKBACKER", "OIADVANTAGE",
                    "TTRACY")
                .putAll(SPEECH, "fsh_")
                .build()
                .inverse()));
