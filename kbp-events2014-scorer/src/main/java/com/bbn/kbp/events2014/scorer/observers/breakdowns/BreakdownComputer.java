...
public final class BreakdownComputer<ProvenanceType> {
    ...
    public static <ProvenanceType> BreakdownComputer create(Map<String, Function<ProvenanceType, Symbol>>
          breakdownFunctions)
    {
    ...
    private static final Ordering<Symbol> BREAKDOWN_KEY_ORDERING = Ordering.from(new SymbolUtils.ByString());
