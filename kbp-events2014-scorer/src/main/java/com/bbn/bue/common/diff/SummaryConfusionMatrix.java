...
public abstract class SummaryConfusionMatrix {
    ...
    /**
     * The special case where there are only two labels is very common, so we provide
     * a much more efficient implementation for it.  This makes a noticeable difference when
     * e.g. doing bootstrap sampling with many different score breakdowns.
     */
