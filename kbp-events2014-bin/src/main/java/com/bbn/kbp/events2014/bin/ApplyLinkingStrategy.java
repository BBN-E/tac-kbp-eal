    ...
    private ApplyLinkingStrategy() {
	 ...
	 public static void main(final String[] argv) {
		 ...
		 try {
			 ...
			 final File argumentSystemStoreDir = params.getExistingDirectory("argumentSystemStore");	// system EA tuples	         
			 ...
			 final SystemOutputStore argumentSystemStore = AssessmentSpecFormats.openSystemOutputStore(argumentSystemStoreDir, fileFormat);
			 final ImmutableSet<Symbol> docIDs = argumentSystemStore.docIDs();
			 
			 final File linkingSystemStoreDir = params.getExistingDirectory("linkingSystemStore");	// destination directory to write to
			 ...
			 LinkingStrategy linkingStrategy = SameEventTypeLinker.create(ImmutableSet.of(KBPRealis.Actual, KBPRealis.Other));
