...
/**
 * The pilot assessment annotation store does not entirely meet the specification.  This program
 * will transform such an annotation store to a compliant one, at the cost of throwing away some
 * malformed response annotations.
 */
public final class RepairAnnotationStore {
  ...
  private static void trueMain(String[] argv) throws IOException {
    ...
    final RecoveryAssessmentCreator assessmentCreator =
        RecoveryAssessmentCreator.createWithRandomSeed(rng);
    ...
    final AnnotationStore outStore =
        AssessmentSpecFormats.createAnnotationStore(outputStorePath, fileFormat);
