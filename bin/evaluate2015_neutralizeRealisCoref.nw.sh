...
mkdir -p $EVALDIR/score_nw/neutralizeRealisCoref
$KBPREPO/kbp-scorer-bbn/target/appassembler/bin/kbpScorer2015 $PARAMSDIR/BBNKBPScorer2015.nw.neutralizeRealisCoref.params > $LOG/scorer2015_neutralizeRealisCoref.nw.log
