...
mkdir -p $EVALDIR/score_nw/neutralizeRealis
$KBPREPO/kbp-scorer-bbn/target/appassembler/bin/kbpScorer2015 $PARAMSDIR/BBNKBPScorer2015.nw.neutralizeRealis.params > $LOG/scorer2015_neutralizeRealis.nw.log
