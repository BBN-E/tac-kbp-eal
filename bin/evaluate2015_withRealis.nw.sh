...
mkdir -p $EVALDIR/score_nw/withRealis
$KBPREPO/kbp-scorer-bbn/target/appassembler/bin/kbpScorer2015 $PARAMSDIR/BBNKBPScorer2015.nw.params > $LOG/scorer2015.nw.log
