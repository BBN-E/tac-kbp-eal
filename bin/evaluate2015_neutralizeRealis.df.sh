...
mkdir -p $EVALDIR/score_df/neutralizeRealis
$KBPREPO/kbp-scorer-bbn/target/appassembler/bin/kbpScorer2015 $PARAMSDIR/BBNKBPScorer2015.df.neutralizeRealis.params > $LOG/scorer2015_neutralizeRealis.df.log
