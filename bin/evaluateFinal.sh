...
then
    ...
    $KBPOPENREPO/tac-kbp-eal/target/appassembler/bin/expandByRealis $KBPOPENREPO/params/final/expand.params >> $LOG
fi
...
then
    ...
    $KBPOPENREPO/tac-kbp-eal/target/appassembler/bin/applyQuoteFilter $KBPOPENREPO/params/final/quoteFilter.params >> $LOG
fi

# score
echo "scoring..."
$KBPOPENREPO/tac-kbp-eal/target/appassembler/bin/kbpScorer $KBPOPENREPO/params/final/score.params >> $LOG
