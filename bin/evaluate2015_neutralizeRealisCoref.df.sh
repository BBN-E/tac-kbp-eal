...
mkdir -p $EVALDIR/score_df/neutralizeRealisCoref
$KBPREPO/kbp-scorer-bbn/target/appassembler/bin/kbpScorer2015 $PARAMSDIR/BBNKBPScorer2015.df.neutralizeRealisCoref.params > $LOG/scorer2015_neutralizeRealisCoref.df.log
