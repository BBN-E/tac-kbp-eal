...
mkdir -p $EVALDIR/score/neutralizeRealisCoref
$KBPREPO/kbp-scorer-bbn/target/appassembler/bin/kbpScorer2015 $PARAMSDIR/BBNKBPScorer2015.neutralizeRealisCoref.params > $LOG/scorer2015_neutralizeRealisCoref.log
