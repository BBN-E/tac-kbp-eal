...
public final class AllFields {
  ...
  public static AllFields create(final Symbol docid, final Symbol type, final Symbol role,
    ...
    return new AllFields(docid, type, role, realis, argumentCanonicalString,
        ImmutableList.copyOf(argumentJustifications),
        ImmutableList.copyOf(predicateJustifications));
  }
  ...
  public int hashCode() {
    return Objects
        .hashCode(docid, type, role, realis, argumentCanonicalString, argumentJustifications,
  ...
  private AllFields(final Symbol docid, final Symbol type, final Symbol role,
      final KBPRealis realis,
      final String argumentCanonicalString,
      final List<CharOffsetSpan> argumentJustifications,
      final List<CharOffsetSpan> predicateJustifications) {
    this.docid = docid;
    this.type = type;
    this.role = role;
