...
/**
 * Holds two different collections of answers to a single {@link Answerable} item.  For example, in
 * scoring a parser, the {@code Answerable} might be a span of words, the {@code leftAnswers} could
 * be the parser predicted non-terminal symbols (could be more than one in the case of unary
 * projections) and the {@code rightAnswers} could be the gold standard answers.
 *
 ...
 * @param <RightAnswer> The type of the right answers. This will sometimes but not always be the
 *                      same as the left answers.
 * @author rgabbard
 */
public final class AlignedAnswers<Answerable, LeftAnswer, RightAnswer> {

  private AlignedAnswers(final Answerable answerable, final Iterable<LeftAnswer> leftAnswers,
      final Iterable<RightAnswer> rightAnswers) {
  ...
  AlignedAnswers<Answerable, LeftAnswer, RightAnswer> create(
      final Answerable answerable, final Iterable<LeftAnswer> leftAnswers,
      final Iterable<RightAnswer> rightAnswers) {
    return new AlignedAnswers<Answerable, LeftAnswer, RightAnswer>(answerable, leftAnswers,
        rightAnswers);
  }
